...
//	//修改中
//	public static Object fromss(String ss, String encoding) throws Exception
//	{		
//		
//		InputStream inputStream = new FileInputStream(ss);
//		try {
//			int ssSize = (int)ss.length();
//			byte[] data = new byte[ssSize];
//			int n = inputStream.read(data);
//			
//			int offset = 0;
//			encoding=encoding.toUpperCase();
...
//	public JSONObject jsonToObject(JSONString string) {
//		JSONObject jsonObject = JSONObject.fromJSONString(string);
//		return jsonObject;
//	}
